...
def submission_to_out(sub: Submission) -> dict:
    ...
    return {
        ...
        "source_type": getattr(sub, "source_type", None),
        "zip_path": getattr(sub, "zip_path", None),
        ...
        "current_step": getattr(sub, "current_step", None),
        "step_details": getattr(sub, "step_details", None) or {},
        ...
        "review_message": getattr(sub, "review_message", None),
        "reviewed_at": getattr(sub, "reviewed_at", None),
        "reviewer_employee_id": getattr(sub, "reviewer_employee_id", None),
